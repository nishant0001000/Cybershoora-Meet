...
const page = () => {
  ...
  const showToasts = (message, type = "info") => {
    toast[type](message, {
      position: "top-right",
      autoClose: 3000,
      transition: Slide,
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-4">
            <Button
              className="w-full dark:hover:bg-gray-600 dark:hover:text-black"
              variant="outline"
          ...
          <div className="flex flex-col space-y-4 mt-6">
            ...
            <Button
              className="w-full bg-black text-white dark:hover:bg-gray-600 dark:bg-white dark:text-black"
              variant="ghost"
